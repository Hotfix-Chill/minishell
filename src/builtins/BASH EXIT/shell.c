WEBSITE https://cgit.git.savannah.gnu.org/cgit/bash.git/tree/shell.c


Zeile 1040–1049: sh_exit(int s) { ... exit(s); } ✅ function call from exit() (libc).
...
generated by cgit v1.2.3 (git 2.25.1) at 2026-02-15 23:30:24 +0000